package com.xxl.ai.api.framework.web.xxllog;
...
public class XxlLogAspect {
     ...
     */
    @Pointcut("@annotation(com.xxl.ai.api.framework.annotation.XxlLog)")
     ...
     */
    //@Around("@annotation(com.xxl.ai.api.framework.annotation.Log)")
    @Around("logPointcut()")
    ...
    private void doLog(XxlLog log,
        ...
        // generate
        com.xxl.ai.api.framework.model.entity.Log xxlBootLog = new com.xxl.ai.api.framework.model.entity.Log();
