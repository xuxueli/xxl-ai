...
import com.xxl.ai.api.framework.constant.enums.ResourceStatuEnum;
import com.xxl.ai.api.framework.constant.enums.ResourceTypeEnum;
import com.xxl.ai.api.framework.mapper.authz.ResourceMapper;
import com.xxl.ai.api.framework.mapper.authz.RoleResMapper;
...
public class ResourceServiceImpl implements ResourceService {
	...
	*/
	...
	public List<XxlAiResourceDTO> treeListByUserId(int userId) {
		List<XxlAiResource> resourceList = resourceMapper.queryResourceByUserId(userId, ResourceStatuEnum.NORMAL.getCode());
		return generateTreeList(resourceList);
	}*/
