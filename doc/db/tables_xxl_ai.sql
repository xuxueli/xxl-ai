...
CREATE TABLE `xxl_ai_message`
(
    `id`            BIGINT          NOT NULL AUTO_INCREMENT      COMMENT '消息ID',
    `category`      INT             NOT NULL                     COMMENT '分类（0-通知、1-公告）',
...
CREATE TABLE `xxl_ai_message_read` (
...
CREATE TABLE `xxl_ai_codegen_field`
(
    `id`              BIGINT          NOT NULL AUTO_INCREMENT      COMMENT '编号',
...
INSERT INTO `xxl_ai_user` (`id`, `org_id`, `username`, `password`, `token`, `status`, `real_name`, `add_time`, `update_time`)
...
INSERT INTO `xxl_ai_org` (`id`, `parent_id`, `name`, `order`, `status`, `manager`, `add_time`, `update_time`)
VALUES (1, 0, 'XXL-AI项目组', 1, 0, 'admin', now(), now()),
       (2, 1, '研发A组', 11, 0, '11', now(), now()),
       (3, 1, '研发B组', 12, 0, '12', now(), now());

INSERT INTO `xxl_ai_message` (`category`, `title`, `content`, `sender`, `status`, `add_time`, `update_time`)
VALUES (0, 'XXL-AI | 快速开发平台', '<p><strong>XXL-AI </strong>是一个快速开发平台，易学易用、AI驱动、开箱即用。整合前后端流行技术，致力为 中小企业、个人开发者 打造开箱即用的中后台解决方案。</p>', 'admin', 0, now(), now()),
       (0, 'XXL-AI | 快速开发平台', '<p><strong>XXL-AI </strong>是一个快速开发平台，易学易用、AI驱动、开箱即用。整合前后端流行技术，致力为 中小企业、个人开发者 打造开箱即用的中后台解决方案。</p>', 'admin', 0, now(), now()),
       (0, 'XXL-AI | 快速开发平台', '<p><strong>XXL-AI </strong>是一个快速开发平台，易学易用、AI驱动、开箱即用。整合前后端流行技术，致力为 中小企业、个人开发者 打造开箱即用的中后台解决方案。</p>', 'admin', 0, now(), now()),
       (0, 'XXL-AI | 快速开发平台', '<p><strong>XXL-AI </strong>是一个快速开发平台，易学易用、AI驱动、开箱即用。整合前后端流行技术，致力为 中小企业、个人开发者 打造开箱即用的中后台解决方案。</p>', 'admin', 0, now(), now()),
       (0, 'XXL-AI 新版发布 | 快速开发平台', '<p><strong>XXL-AI </strong>是一个快速开发平台，易学易用、AI驱动、开箱即用。整合前后端流行技术，致力为 中小企业、个人开发者 打造开箱即用的中后台解决方案。</p>
<p>&nbsp;</p> <p><u><strong>项目文档</strong></u>：<a href="https://www.xuxueli.com/xxl-ai/" target="_blank">https://www.xuxueli.com/xxl-ai/</a></p> <p><u><strong>GitHub地址</strong></u>：<a href="https://github.com/xuxueli/xxl-ai/" target="_blank">https://github.com/xuxueli/xxl-ai/</a></p>
', 'admin', 0, now(), now());
...
INSERT INTO xxl_ai.xxl_ai_dict (id, name, type, status, add_time, update_time, remark)
VALUES (1, '用户性别', 'sex', 0, '2026-08-02 02:33:53', '2026-08-02 02:33:53', null);

INSERT INTO xxl_ai.xxl_ai_dict_item (id, dict_id, name, code, status, `order`, add_time, update_time, remark)
